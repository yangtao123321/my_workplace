...
public class OtherTools {
    ...
    //负责部门为本部门的签字审批
    public static void makereport(OtherPlan otherPlan,Flowinfos flowinfos) {
        ...
        try{
            ...
            Paragraph elements = new Paragraph(otherPlan.getOthertitle(), setChineseFont());
            ...
            datatable.addCell(createrepairecontext("            "+otherPlan.getBuyreson(), 5, 1));//将前后空格去掉后在前面加3个tab
            ...
            if (res>0) {
                ...
                datatable.addCell(createrepairerequiresdetail("品名", 2, 1));
                datatable.addCell(createrepairerequiresdetail("厂家", 1, 1));
                datatable.addCell(createrepairerequiresdetail("规格", 1, 1));
                datatable.addCell(createrepairerequiresdetail("数量", 1, 1));

                for (OtherDetail detail:otherPlan.getOtherDetails()) {

                    datatable.addCell(createrepairerequiresdetail(detail.getOtherproname(),2,1));
                    datatable.addCell(createrepairerequiresdetail(detail.getOthersupplier(),1,1));
                    datatable.addCell(createrepairerequiresdetail(detail.getOtherspecial(),1,1));
                    datatable.addCell(createrepairerequiresdetail(detail.getOthernum(),1,1));
    ...
    //负责部门是其他单位的签字审批
    public static void makereport1() {
        ...
        try{
            ...
            PdfWriter pdfWriter = PdfWriter.getInstance(d, new FileOutputStream("D:/生产章.pdf"));

            d.open();

            Paragraph elements = new Paragraph("采   购   计   划   表", setChineseFont());
            ...
            Image cui=Image.getInstance("D://cuilingling1.png");

            Image zhao=Image.getInstance("D://zhaowei.jpg");

            Image chater=Image.getInstance("D://fenzhenzhang.png");

            img.scaleToFit(65, 65);

            cui.scaleToFit(90,90);
            ...
            chater.setAbsolutePosition(90,200);


            chater.scaleToFit(130,130);
            ...
            datatable.addCell(createlvxintitlecell("305车间",5,1));

            datatable.addCell(createlvxintitlecell("提报日期",1,1));

            datatable.addCell(createlvxintitlecell("2020-02-03",2,1));

            datatable.addCell(createlvxintitlecell("提报人", 1, 1));

            datatable.addCell(createlvxintitlecell("左志泰", 7, 1));

            datatable.addCell(createrepairecontextitle("购   买\r\n\r\n原   因", 1, 1));

            datatable.addCell(createrepairecontext("            123", 5, 1));//将前后空格去掉后在前面加3个tab
            ...
            //循环的列数
                ...
                datatable.addCell(createrepairerequiresdetail("数量", 1, 1));
                    ...
                    datatable.addCell(createrepairerequiresdetail("注射用呱啦西林钠",2,1));
                    datatable.addCell(createrepairerequiresdetail("高科生物有限公司",1,1));
                    datatable.addCell(createrepairerequiresdetail("1.0g",1,1));
                    datatable.addCell(createrepairerequiresdetail("5支",1,1));
